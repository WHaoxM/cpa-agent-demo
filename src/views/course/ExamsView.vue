...
const list = ref<Exam[]>([
  { id: 'e_01', name: 'Vue3 模块化与路由守卫', time: '2026-02-10 19:30', status: '未开始' },
  { id: 'e_02', name: '组件设计与交互细节', time: '2026-02-07 15:00', status: '进行中' },
  { id: 'e_03', name: '性能优化与可访问性', time: '2026-01-28 20:00', status: '已结束' },
  { id: 'e_04', name: '设计系统 Token 实践', time: '2026-02-03 12:30', status: '已结束' },
])
  ...
  <div class="page">
    <div class="head ui-card">
      <div class="head__left">
        <div class="head__title">考试列表</div>
      </div>
    ...
    <el-card class="table ui-card" shadow="never">
      <el-table :data="filtered" style="width: 100%" size="large">
        <el-table-column prop="name" label="考试" min-width="240" />
